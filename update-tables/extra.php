...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1> EXTRA_ACTIVITIES-DETAILS</h1>
  <div class="cont">
    <img class="mb-4" src="../images/cv.png" alt="icon">
    <form class="form" action="database-extra.php" method="post">
      <div class="form-group">
        <label for="inputresume"> RESUME_ID:
          <input type="text" name="id" id="inputresume"  maxlength="10" required>
        </label>
      </div>
      <div class="form-group">
        <label for="inputACT"> ACTIVITY_CATEGORY:
          <input type="text" name="actc" id="inputACT" required>
        </label>
      </div>
      <div class="form-group">
