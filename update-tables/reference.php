...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1> REFERENCES- DETAILS</h1>
  <div class="cont">
    <img class="mb-4" src="../images/cv.png" alt="icon">
    <form class="form" action="database-reference.php" method="post">
      ...
      <div class="form-group">
        <label for="inputblog"> BLOG_LINK:
          <textarea type="text" name="blog" id="inputblog"  cols="20" ></textarea>
        </label>
      </div>
      <div class="form-group">
        <label for="inputlink"> LINKEDIN_ID:
          <textarea type="text" name="link" id="inputlink" cols="25" rows="2"></textarea>
        </label>
      </div>
      <div class="form-group">
        <label for="inputgit"> GITHUB_ID:
          <textarea type="text" name="git" id="inputgit"  cols="23" ></textarea>
        </label>
      </div>
      <div class="form-group">
